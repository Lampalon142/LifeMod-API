...
public class StaffItem {
    ...
    public StaffItem(String key, ItemStack itemStack, int slot, Map<String, List<String>> actionScripts) {
        ...
        this.slot = slot;
        this.actionScripts = actionScripts == null
                ? Map.of()
                : Collections.unmodifiableMap(actionScripts);
    }
    ...
    public Set<String> getClickTypes() {
        return actionScripts.keySet();
    }

    public List<String> getScripts(String clickType) {
        return actionScripts.getOrDefault(clickType, List.of());
    }
}