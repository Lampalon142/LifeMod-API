...
public class CommandContext {
    ...
    // --- NMS Abstraction (Placeholder - to be expanded as needed) ---
    // This is where version-specific player interactions would be abstracted.
    // For now, it provides direct Bukkit Player access, but can be enhanced
    // with an NMSPlayerAdapter interface and implementation.

    /**
     * Provides access to player-specific functionalities that might require NMS interaction.
     * For now, returns the Bukkit Player directly, but can be wrapped by an NMS-abstracted object.
     *
     * @return The Bukkit Player if the sender is a player, otherwise null.
     */
