...
public class NoteCommand extends BaseSanctionCommand {
    public NoteCommand(LifeMod plugin) {
        super("note", "lifemod.note", SanctionType.NOTE, "Add a private staff note to a player.", "/note <player> <content>", plugin);
    }
    ...
    protected void onSanctionApplied(CommandContext context, OfflinePlayer target, Sanction sanction) {
        ...
        // No message to player (private note)
    }
}
