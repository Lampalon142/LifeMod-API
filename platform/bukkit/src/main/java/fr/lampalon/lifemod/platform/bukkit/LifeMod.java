...
public class LifeMod extends JavaPlugin {
    ...
    private void initializeManagers() {
        ...
        if (configConfig.getBoolean("modules.noclip.enabled", true)) {
            noClipManager = new fr.lampalon.lifemod.platform.bukkit.managers.NoClipManager(this);
            getServer().getPluginManager().registerEvents(
                    new fr.lampalon.lifemod.platform.bukkit.listeners.NoClipListener(noClipManager), this
            );
        }
